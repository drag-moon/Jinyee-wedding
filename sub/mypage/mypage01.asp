	...
	<div class="content_100 white_bg">
        <div class="inner_box">
			...
			<div class="deps2_group">
			  <button class="deps2_bt deps2_on" onClick="location.href='/sub/mypage/mypage01.asp'">정보보기</button>
			  <button class="deps2_bt" onClick="location.href='/sub/mypage/mypage02.asp'">정보수정</button>
