...
(function($) {
    ...
    Accordion.prototype.init = function() {
        ...
        function closeAccordionSection() {
            $this.find('.submenu-section-header').removeClass('active');
            $this.find('.submenu-section-content').slideUp(options.transition_delay).removeClass('open');
        }

        function closeAccordionBy($accodionSection) {
            $accodionSection.find('.submenu-section-header').removeClass('active');
            $accodionSection.find('.submenu-section-content').slideUp(options.transition_delay).removeClass('open');
        }
        ...
        $this.find('.submenu-section-header').click(function(e) {
            e.preventDefault();
            ...
            if (options.toggle) {
                ...
                if ($(e.target).is('.active')) {
                    closeAccordionBy($(this).closest('.submenu-section'));
                } else {
                    openAccordion($(this));
                }
            }
